...
@app.post("/forge/validate_field")
async def forge_validate_field(request: Request):
    """Targeted field assist alias for the wizard's AI-assist buttons."""
    return await forge_interview(request)
...
async def forge_assemble(request: Request):
    ...
    return {
        "message": f"Skill forged! Files saved to sandbox/ and indexed in Qdrant.",
        "path": py_path,
        "md_path": md_path
    }
